...
export default class PermissionsModal extends React.Component {
  ...
  componentDidMount() {
    setTimeout(() => {
      this.setState({ showReloadHelper: true });
    }, 1800);
  }
    ...
    return (
      <div className={styles.permissionsContainer}>
        ...
        {this.state.showReloadHelper && (
          <h4 onClick={this.reloadPage} className={styles.reloadHelper}>
            If no box shows, click here
          </h4>
        )}
        <img
          src="/images/dashboard/green-up-arrow.png"
