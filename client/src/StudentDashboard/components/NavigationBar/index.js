  ...
  const popoverClickRootClose = (
    ...
    return (
      <div className={[navClass, css.navContainer, barColorClass].join(' ')}>
        ...
        { ((this.props.isCoverPage || this.props.showBookInfo) && (!this.props.inComp && !this.props.inSpelling)) &&
        ...
        { ((this.props.isCoverPage || this.props.showBookInfo) && this.props.inSpelling) &&
