...
export const words = ['shaking', 'bagged', 'batter', 'running', 'bitter', 'hiking', 'tennis', 'gripped', 'warning', 'dinner', 'retain', 'happen', 'explode', 'disturb', 'review', 'survive', 'explain', 'return', 'complain', 'boring']
export const responses = ['shaking', 'bagged', 'bater', 'running', 'bitter', 'hiking', 'tennis', 'gripped', 'warning', 'dinner', 'retane', 'happen', 'explode', 'disturb', 'review', 'survive', 'explane', 'return', 'complain', 'boring']

export const titles = ['Words', 'Student Responses', '-ed/ing Endings', 'Doubling at Syllable Juncture', 'Long-Vowel Two-syllable Words', 'R-Controlled Two-Syllable Words']
...
export const rControlled = [null, null, null, null, null, null, null, null, true, null, null, null, null, true, null, true, null, true, null, true]
