class Classroom < ApplicationRecord
  ...
  def self.create_with_teacher_and_students_and_assesssments(options = {})
    ...
    ActiveRecord::Base.transaction do
      ...
      student_list.each do |stu|
        ...
        if name_hash
          ...
          cl.students.each do |student|
            student.assessments.new(book_key: book_key)
          end 
